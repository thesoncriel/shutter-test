...
begin
  ...
  FCaptureOpt.OnAutoCaptureStartEvent := OnAutoCaptureStart;
  FCaptureOpt.OnAutoCaptureStopEvent := OnAutoCaptureStop;
end;
...
begin
  ...
  Label_AutoCapture.Visible := true;
...
begin
  FImageCapture.AutoCaptureStop;
  Label_AutoCapture.Visible := false;
