...
begin
  ...
  shutterView.OnChangePartState := OnChangePartItemState;
...
begin
  if Assigned( OnChangePartState ) then
    OnChangePartState( Sender, Index, operVal );
end;

procedure TFrame_ShutterViewGroup.SaveAllRecipe;
var
  i: Integer;
begin
