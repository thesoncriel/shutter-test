...
const
  PARSE_INFO_NAMES: array[0..3] of string = ('GetOpen', 'GetClose', 'SetOpen', 'SetClose');
...
begin
  ...
  begin
    ...
    part.Name := iniFile.ReadString( sSectionName, 'Name', 'partName' );
    self.Add( part );
  end;
...
begin
  Result := TAbsPart( FItems.Items[ Index ] );
end;
